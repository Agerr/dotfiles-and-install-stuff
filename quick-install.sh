...
paru -S systemd-numlockontty numlockx i3lock-fancy-git cava autotiling nerd-fonts-jetbrains-mono visual-studio-code-bin icu69-bin gitkraken spotify timeshift discord-ptb betterdiscord-installer grub-customizer spicetify-cli onlyoffice-bin
