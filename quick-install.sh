...
paru -S --noconfirm systemd-numlockontty numlockx i3lock-fancy-git cava autotiling nerd-fonts-jetbrains-mono visual-studio-code-bin icu69-bin gitkraken spotify-edge timeshift discord-ptb betterdiscord-installer-bin grub-customizer spicetify-cli onlyoffice-bin
